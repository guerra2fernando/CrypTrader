    ...
    <div className="space-y-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Latest backtests pulled from MongoDB. Click a row to inspect equity and trade stats.</CardDescription>
        </CardHeader>
        <CardContent className="overflow-x-auto">
          {runs.length ? (
            ...
            <p className="text-sm text-muted-foreground">No simulations have been run.</p>
          )}
        </CardContent>
      </Card>
